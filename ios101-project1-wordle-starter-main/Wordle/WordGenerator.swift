...
class WordGenerator {
  // Exercise 8(I think done?): Add more possible words and return a **random** string every time `generateRandomWord` is called
  ...
  static let possibleWords = ["ABCDE", "TOBY", "SMYAN", "IJWON", "KOBEJ"]
  static func generateRandomWord() -> String? {
    // START YOUR CODE HERE
    var tt = possibleWords.randomElement()
    // END YOUR CODE HERE
    return tt
  }
}

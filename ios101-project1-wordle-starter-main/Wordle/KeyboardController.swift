...
class KeyboardController: NSObject,
  ...
  func collectionView(_ collectionView: UICollectionView,
    ...
    // Exercise 1(DONE): Return the correct number of items in a section
  ...
  func collectionView(_ collectionView: UICollectionView,
    ...
    // Exercise 4(DONE): Pass in the `didSelectString` closure to the KeyboardCell's corresponding property
    // START YOUR CODE HERE
